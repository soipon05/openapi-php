...
readonly final class DomesticPet
{
     ...
     * @phpstan-assert DomesticPetData $data
     * @return self
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            ownerName: isset($data['ownerName']) ? TypeAssert::requireString($data, 'ownerName') : null,
            ownerEmail: isset($data['ownerEmail']) ? TypeAssert::requireString($data, 'ownerEmail') : null,
            vaccinated: isset($data['vaccinated']) ? TypeAssert::requireBool($data, 'vaccinated') : null,
        );
    }
